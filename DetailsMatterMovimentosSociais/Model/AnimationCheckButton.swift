...
//
//  Created by Helaine Pontes on 29/09/20.
...
@IBDesignable
open class AnimationCheckButton: UIButton {
    ...
    fileprivate func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(AnimationCheckButton.touchDown(_:)), for: UIControl.Event.touchDown)
        self.addTarget(self, action: #selector(AnimationCheckButton.touchUpInside(_:)), for: UIControl.Event.touchUpInside)
        self.addTarget(self, action: #selector(AnimationCheckButton.touchDragExit(_:)), for: UIControl.Event.touchDragExit)
        self.addTarget(self, action: #selector(AnimationCheckButton.touchDragEnter(_:)), for: UIControl.Event.touchDragEnter)
        self.addTarget(self, action: #selector(AnimationCheckButton.touchCancel(_:)), for: UIControl.Event.touchCancel)
    }

    @objc func touchDown(_ sender: AnimationCheckButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: AnimationCheckButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: AnimationCheckButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: AnimationCheckButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: AnimationCheckButton) {
        self.layer.opacity = 1.0
    }
