...
""", imagem: "abglt", eventos: EventosMockLgbt.eventosAbglt, urlInstagram: "https://www.instagram.com/abglt.oficial/", urlWebSite: "https://www.abglt.org/copia-quem-somos", urlFacebook: "https://www.instagram.com/abglt.oficial/")
    ...
    let casaNem = Movimento(nome: "Casa Nem", descricao: "A Casa Nem é um espaço de acolhimento para pessoas LGBTIs em situação de vulnerabilidade social,com foco em transexuais e transgeneres. É um espaço autosustentável e festas são realizadas para ajudar nessa autosustentabilidade do local,que também recebe diversos tipos de doações. Na Casa Nem opressões são proibides e o espaço abriga diversos projetos que se inclui o PreparaNem, CosturaNem, FotografaNem, YogaNem, Libras, voltado para as travestis, trans e a todes que se considerem Nem.", imagem: "casanem", eventos: EventosMockLgbt.eventosCasaNem, urlInstagram: "https://www.instagram.com/casanem_/", urlWebSite: nil, urlFacebook: "https://www.facebook.com/casanemcasaviva/")
    
    static var movimentos: [Movimento] = [MockLgbt().todxs, MockLgbt().maes, MockLgbt().abglt, MockLgbt().casaNem]
}
